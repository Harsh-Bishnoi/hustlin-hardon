                    ...
                    <div className="w-full overflow-hidden">
                        <div className="flex gap-15.5 max-md:gap-14">
                            <div className="flex items-center gap-[7px]">
                                ...
                                <p
                                    className="text-[#FF0000] text-sm leading-[130%] uppercase rounded-[5px] border border-[#FF0000] py-[2.5px] px-1.5"
                                >
                                    -1.01%
                                </p>
                            </div>
                            <div className="flex items-center gap-[7px]">
                                ...
                                <p
                                    className="text-[#FFD600] text-sm leading-[130%] uppercase rounded-[5px] border border-[#FFD600] py-[2.5px] px-1"
                                >
                                    +0.87%
                                </p>
                            </div>
